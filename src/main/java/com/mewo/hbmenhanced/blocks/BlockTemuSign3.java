...
public class BlockTemuSign3 extends BlockContainer {

    public BlockTemuSign3() {
        super(Material.iron);
        this.setBlockName("temuSign3");
        this.setBlockTextureName("hbmenhanced:temuSign3");
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityTemuSign3();
    }
}