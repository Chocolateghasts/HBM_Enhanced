...
import com.mewo.hbmenhanced.blocks.tileentity.TileEntityTemuSign1;

public class RenderTemuSign1 extends TileEntitySpecialRenderer {

    @Override
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partialTicks) {
        if (!(te instanceof TileEntityTemuSign1))
            return;

        TileEntityTemuSign1 sign = (TileEntityTemuSign1) te;

        GL11.glPushMatrix();
        GL11.glTranslated(x + 0.5, y + 0.5, z + 0.95);
        GL11.glRotatef(180, 0, 1, 0);
        GL11.glScalef(10.0F, 4.0F, 1.0F);
