...
public class EntitySovietSoldier extends EntityMob implements IRangedAttackMob, ISuffocationImmune {


    public EntitySovietSoldier(World world) {
        super(world);
    ...
    protected void addRandomArmor() {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(ModItems.gun_carbine));
