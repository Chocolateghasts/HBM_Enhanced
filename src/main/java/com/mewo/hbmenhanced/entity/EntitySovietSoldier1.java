...
public class EntitySovietSoldier1 extends EntityMob implements IRangedAttackMob, ISuffocationImmune {


    public EntitySovietSoldier1(World world) {
        super(world);
    ...
    protected void addRandomArmor() {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(ModItems.gun_maresleg));
