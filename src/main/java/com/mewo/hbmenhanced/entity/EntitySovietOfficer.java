...
public class EntitySovietOfficer extends EntityMob implements IRangedAttackMob, ISuffocationImmune {


    public EntitySovietOfficer(World world) {
        super(world);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if(source instanceof EntityDamageSourceIndirect && ((EntityDamageSourceIndirect)source).getEntity() instanceof EntitySovietOfficer) {
            return false;
        }
