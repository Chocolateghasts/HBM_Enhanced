...
import static com.mewo.hbmenhanced.ResearchBlocks.Util.Gui.UtilGuiTerminal.setColor;
import static com.mewo.hbmenhanced.hbmenhanced.network;

public class GuiResearchTerminal1 extends GuiScreen {
    ...
    // Constants
    public static final int VIEWPORT_LEFT = 21;
    public static final int VIEWPORT_TOP = 28;
    public static final int VIEWPORT_WIDTH = 234;
    public static final int VIEWPORT_HEIGHT = 154;
    ...
    // Constructor
    public GuiResearchTerminal1(String team) {
    ...
    private boolean isInViewport(int x, int y, int width, int height) {
        ...
        int right = left + VIEWPORT_WIDTH;
        int bottom = top + VIEWPORT_HEIGHT;
...
//        System.out.println("Arrow V: " + v);
    ...
    private void enableScissor() {
        ...
        // Convert GUI-space to actual pixel-space for GL11
